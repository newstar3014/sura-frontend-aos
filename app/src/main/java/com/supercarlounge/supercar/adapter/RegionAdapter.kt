...
class RegionAdapter(val con: Context, val data: ArrayList<String>, val model: BottomSheetRegionDailogViewModel, val itemClick: (String, Int) -> Unit) : RecyclerView.Adapter<RegionAdapter.ViewHolder>() {
    var selectindex = 0
    ...
    inner class ViewHolder(parent: ViewGroup) : RecyclerView.ViewHolder(
        ...
        private val binding: ItemRegionBinding? = DataBindingUtil.bind(itemView)
