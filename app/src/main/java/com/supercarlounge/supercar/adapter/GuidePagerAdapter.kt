...
class GuidePagerAdapter(context: Context, var owner:LifecycleOwner, var list :ArrayList<SlidePidData>, val itemClick: (SlidePidData, Int) -> Unit) : PagerAdapter(){
    ...
    companion object {
        ...
        fun setbanner(pager: ViewPager, items: ArrayList<SlidePidData>) {
          var adapter =  (pager.adapter as GuidePagerAdapter)
            items?.let {
