...
class BannerPager2Adapter(
    ...
    companion object {
        ...
        @BindingAdapter("app:bannersTop")
        @JvmStatic
        fun setbannerTop(pager: ViewPager, items: ArrayList<BannerData>) {
            var adapter = (pager.adapter as BannerPager2Adapter?)
            items?.let {
