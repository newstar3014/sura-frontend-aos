...
class SpotImagePagerAdapter(context: Context, list :ArrayList<String>, val itemClick: (String, Int) -> Unit) : PagerAdapter(){
    ...
    fun addAllItem(list: ArrayList<String> /* = java.util.ArrayList<com.example.supercarx.data.BannerData> */){
        mlist = list
    ...
    companion object {
        ...
        @JvmStatic
        fun setbanner(pager: ViewPager, items: ArrayList<String>) {
          var adapter =  (pager.adapter as SpotImagePagerAdapter)
            items?.let {
