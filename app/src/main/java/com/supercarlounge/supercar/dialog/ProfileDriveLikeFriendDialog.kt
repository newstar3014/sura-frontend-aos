...
import com.supercarlounge.supercar.databinding.DialogProfileBrowseDriveBinding
...
class ProfileDriveLikeFriendDialog(
    context: Context,
    var nick:String,
    ...
    var binding: DialogProfileBrowseDriveBinding? = null
...
//    var mListener: DialogListener? = null
    ...
    override fun onCreateView(
        ...
        binding = DataBindingUtil.inflate(
            ...
            R.layout.dialog_profile_browse_drive,
            null,
            false
        );
        return binding!!.root
    ...
    private fun setText(){
        when(viewmodel!!.type.value){
            PopTypeStatus.DRIVE_FRIEND->{
                ...
                var content =  getString(R.string.friend_drive_main_drive)
