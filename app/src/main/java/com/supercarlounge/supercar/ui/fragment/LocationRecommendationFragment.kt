...
class LocationRecommendationFragment() : Fragment() {
    val TAG = "LocationRecommendationFragment"
...
//            }
    ...
    fun newInstance(type: Int): LocationRecommendationFragment {
        val args = Bundle()
//        viewModel.rvItemType.value = type
        val fragment = LocationRecommendationFragment()
