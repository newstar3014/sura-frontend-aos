...
import com.supercarlounge.supercar.databinding.FragementMatchingCompletionBinding
...
class MatchingCompletionFragment : Fragment() {
    var application:MainApplication?=null
    private var _binding: FragementMatchingCompletionBinding? = null
    ...
    override fun onCreateView(
       ...
       viewModel = ViewModelProvider(this).get(MatchingViewModel::class.java)
        _binding = FragementMatchingCompletionBinding.inflate(inflater, container, false)
    ...
    fun newInstance(): MatchingCompletionFragment {
        val args = Bundle()

        val fragment = MatchingCompletionFragment()
