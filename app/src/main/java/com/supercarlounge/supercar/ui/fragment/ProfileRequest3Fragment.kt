...
import com.supercarlounge.supercar.databinding.FragmentRequest3Binding
...
class ProfileRequest3Fragment:Fragment() {
    val TAG = "ProfileRequest1Fragment"
    var application:MainApplication? = null
    private var binding: FragmentRequest3Binding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentRequest3Binding.inflate(inflater, container, false)
...
// 다른 곳 터치 시 기존 선택했던 뷰 닫기
    ...
    override fun onResume() {
        super.onResume()
        viewModel.getrequest("받은 호감")
    }
    fun newInstance(): ProfileRequest3Fragment {
        val args = Bundle()
        val fragment = ProfileRequest3Fragment()
