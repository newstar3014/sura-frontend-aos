...
class LocationFinediningFragment() : Fragment() {
    ...
    override fun onResume() {
        ...
        viewModel.getSpotList(true,"파인다이닝")
...
//            }
    ...
    fun newInstance(type: Int): LocationFinediningFragment {
        val args = Bundle()
//        viewModel.rvItemType.value = type
        val fragment = LocationFinediningFragment()
