...
class LocationCourseFragment() : Fragment() {
    ...
    override fun onResume() {
        ...
        viewModel.getSpotList(true,"드라이브 코스")
...
//            }
    ...
    fun newInstance(type: Int): LocationCourseFragment {
        val args = Bundle()
//        viewModel.rvItemType.value = type
        val fragment = LocationCourseFragment()
