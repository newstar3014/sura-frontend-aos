...
import com.supercarlounge.supercar.databinding.ActivityDriveVipPassGuideBinding
import com.supercarlounge.supercar.viewmodel.AlimViewModel


class DrivePassVipGuideActivity: BaseActivitiy() {

    private lateinit var binding: ActivityDriveVipPassGuideBinding
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        binding = ActivityDriveVipPassGuideBinding.inflate(layoutInflater)
