...
import com.supercarlounge.supercar.databinding.FragmentRequest1Binding
...
class ProfileRequest1Fragment:Fragment() {
    val TAG = "ProfileRequest1Fragment"
    var application:MainApplication? = null
    private var binding: FragmentRequest1Binding? = null
    ...
    override fun onCreateView(
        ...
        binding = FragmentRequest1Binding.inflate(inflater, container, false)
...
// 다른 곳 터치 시 기존 선택했던 뷰 닫기
    ...
    override fun onResume() {
        super.onResume()
        viewModel.getrequest("나를 열람한")
    }
    fun newInstance(): ProfileRequest1Fragment {
        val args = Bundle()
        val fragment = ProfileRequest1Fragment()
