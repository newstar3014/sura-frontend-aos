...
class PrvMyCarBoardFragment() : Fragment(), DialogEvent {
...
//                i.putExtra("data", viewModel!!.myCarBestBoardLists.value?.get(it))
...
//            requireActivity().overridePendingTransition(com.supercarlounge.supercar.R.anim.fadein, com.supercarlounge.supercar.R.anim.fadeout)
    ...
    fun newInstance(): PrvMyCarBoardFragment {
        val args = Bundle()

        val fragment = PrvMyCarBoardFragment()
